<div class="w-full mx-auto">
    <div class="bg-white overflow-hidden shadow-xl sm:rounded-xl border border-emerald-100">
        ...
        <div class="bg-gradient-to-r from-emerald-50 to-emerald-100 px-6 py-8 border-b border-emerald-200">
            <h2 class="text-3xl font-bold text-emerald-800">Profil Kepala Sekolah</h2>
            <p class="text-emerald-600 mt-1">Kelola data profil kepala sekolah</p>
        </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            <x-label for="namaKepalaSekolah" value="Nama Kepala Sekolah"
                                class="text-sm font-medium text-gray-700" />
                            <x-input id="namaKepalaSekolah" wire:model.defer="namaKepalaSekolah"
                        ...
                        <!-- NIP -->
                        <div>
                            <x-label for="nip" value="NIP (Opsional)" class="text-sm font-medium text-gray-700" />
                            <x-input id="nip" wire:model.defer="nip"
                                class="mt-2 block w-full border-gray-300 rounded-lg shadow-sm focus:ring-emerald-500 focus:border-emerald-500 transition-colors"
