<div>
    <x-button wire:click="$set('open', true)">Tambah Sub Aspek</x-button>

    <x-dialog-modal wire:model="open">
        <x-slot name="title">Tambah Sub Aspek</x-slot>
        ...
        <x-slot name="content">
            ...
            <div class="mb-4">
                ...
                <textarea id="deskripsi" wire:model.defer="deskripsi" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm"
                    rows="3" placeholder="Deskripsi singkat tentang sub aspek ini"></textarea>
                @error('deskripsi')
                    <span class="text-red-600">{{ $message }}</span>
                @enderror
            </div>
